...
static void test_large(void) {
  static const char text[] =
      ...
      "ipsum, "
      "quia dolor sit amet consectetur adipisci[ng] velit, sed quia non "
      "numquam "
      ...
      "ea "
      "commodi consequatur? [D]Quis autem vel eum iure reprehenderit, qui in "
      "ea "
...
static void test_float(void) {
  char *s = gv_sprint("%.4f as a double or %.4f as a float, "
                      "can be truncated to %.3f",
                      1.2345, 1.2345f, 1.2345);
